...
def plot_comparison_test(results_t, results_w, plot_args=None):
    ...
    for index, result in enumerate(zip(results_t, results_w)):
        result_t = result[0]
        result_w = result[1]
        ...
        ax.errorbar(index, result_t.observed_statistic,  yerr=numpy.array([[ylow, yhigh]]).T ,
